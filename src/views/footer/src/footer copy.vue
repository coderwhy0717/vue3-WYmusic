      ...
      <div class="music-center">
        <div class="playMusic">
          ...
          <div
            ...
            @click="changeref"
          ></div>
          <div class="next iconfont icon-xiayishou" @click="rightBtn"></div>
...
export default defineComponent({
  ...
  setup() {
    ...
    const musicMessage = computed(() => {
      ...
      return store.state.pageMusic.currentMusicId
    })
    onMounted(() => {
      console.log(myRef)
    ...
    const rightBtn = () => {
      ...
      console.dir((lefttext.value.style.left = 0), 'value')
      i = 0
      foo(false)
    }
    // 播放 、暂停播放
